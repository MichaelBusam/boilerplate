...
// Commands
use MichaelBusam\Boilerplate\Console\Commands\ExampleCommand;
use MichaelBusam\Boilerplate\Console\Commands\TestCommand;

// Middleware
use MichaelBusam\Boilerplate\Http\Middleware\ExampleMiddleWare;

// Events
use Illuminate\Support\Facades\Event;
use MichaelBusam\Boilerplate\Events\BoilerplateEvent;
use MichaelBusam\Boilerplate\Listeners\BoilerplateListener;
...
class BoilerplateServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('boilerplate', 'MichaelBusam\Boilerplate\Boilerplate');
    }
